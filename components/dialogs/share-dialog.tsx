        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {currentVisibility === 'private'
              ? 'Rendez cette conversation publique pour la partager avec d’autres.'
              : 'Cette conversation est publique et prête à être partagée.'}
          </DialogDescription>
        </DialogHeader>
          ...
          {currentVisibility === 'private' ? (
            <div className="space-y-3">
              <div className="flex items-center gap-3 p-3 bg-muted/50 rounded-lg border">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">Conversation privée</p>
                  <p className="text-xs text-muted-foreground">Vous seul pouvez voir cette conversation</p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 p-3 bg-blue-50 dark:bg-blue-950/50 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-blue-900 dark:text-blue-100">Conversation publique</p>
                  <p className="text-xs text-blue-700 dark:text-blue-300">Toute personne disposant du lien peut voir cette conversation</p>
                </div>
                <Button
                  variant="outline"
                  size="sm"
